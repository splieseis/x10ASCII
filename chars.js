module.exports = {
  ...
  h: function(asciiArtObj) {
    asciiArtObj[0].push(" _    _ ");
    asciiArtObj[1].push("| |  | |");
    asciiArtObj[2].push("| |__| |");
    asciiArtObj[3].push("|  __  |");
    asciiArtObj[4].push("| |  | |");
    asciiArtObj[5].push("|_|  |_|");
    return asciiArtObj;
  },
  ...
  m: function(asciiArtObj) {
    asciiArtObj[0].push(" _________ ");
    asciiArtObj[1].push("|  _   _  |");
    asciiArtObj[2].push("| | | | | |");
    asciiArtObj[3].push("| | | | | |");
    asciiArtObj[4].push("| | | | | |");
    asciiArtObj[5].push("|_| |_| |_|");
    return asciiArtObj;
  },
  n: function(asciiArtObj) {
    asciiArtObj[0].push(" _   _ ");
    asciiArtObj[1].push("| \\ | |");
    asciiArtObj[2].push("|  \\| |");
    asciiArtObj[3].push("|     |");
  ...
  q: function(asciiArtObj) {
    asciiArtObj[0].push(" _____  ");
    asciiArtObj[1].push("|  _  | ");
    asciiArtObj[2].push("| | | | ");
    asciiArtObj[3].push("| | | | ");
    asciiArtObj[4].push("| |_\\ \\ ");
    asciiArtObj[5].push("|____\\_\\");
    return asciiArtObj;
  },
  r: function(asciiArtObj) {
    asciiArtObj[0].push(" ____   ");
    asciiArtObj[1].push("|  _  \\ ");
    asciiArtObj[2].push("| |_|  |");
    asciiArtObj[3].push("|  _  / ");
  ...
  w: function(asciiArtObj) {
    asciiArtObj[0].push(" _   _   _ ");
    asciiArtObj[1].push("| | | | | |");
    asciiArtObj[2].push("| | | | | |");
    asciiArtObj[3].push("| | | | | |");
    asciiArtObj[4].push("| |_| |_| |");
    asciiArtObj[5].push("|_________|");
    return asciiArtObj;
  },
  x: function(asciiArtObj) {
    asciiArtObj[0].push(" _    _ ");
    asciiArtObj[1].push("\\ \\  / /");
    asciiArtObj[2].push(" \\ \\/ / ");
    asciiArtObj[3].push(" |    | ");
